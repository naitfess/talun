...
@section('content')
<!--begin::Form-->
<form class="form d-flex flex-column flex-lg-row" action="{{ route('admin.artikel.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
    <!--begin::Aside column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="title" class="form-control mb-2" placeholder="Judul Artikel" value="{{ old('title') }}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                @error('title')
