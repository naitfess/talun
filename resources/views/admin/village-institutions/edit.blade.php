...
@section('content')
<!--begin::Form-->
<form class="form d-flex flex-column flex-lg-row" action="{{ route('admin.lembaga-desa.update', ['id' => $villageInstitution->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <!--begin::Main column-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-wrap gap-5">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <div>
                                        <style>.image-input-placeholder { background-image: url('{{ asset('uploads') }}/{{ $villageInstitution->image }}'); } [data-bs-theme="dark"] .image-input-placeholder { background-image: url('{{ asset('uploads') }}/{{ $villageInstitution->image }}'); }</style>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-7 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" class="form-control mb-2" placeholder="Nama Lembaga Desa" value="{{ old('name') ?? $villageInstitution->name }}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                @error('name')
                                <div class="text-danger fs-7">{{ $message }}</div>
                            ...
                            <div>
                                ...
                                <textarea id="tinymce1" name="content" class="tox-target">{{ old('content') ?? $villageInstitution->content }}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                                @error('content')
