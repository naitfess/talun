                ...
                <div class="table-responsive">
                    ...
                    <table class="table align-middle table-row-bordered table-row-solid gy-4 gs-9">
                        ...
                        <tbody class="fw-6 fw-semibold text-gray-600">
                            <tr class="border-0">
                                <td class="pt-0 px-0">
                                    <a href="#" class="text-hover-primary text-gray-600"><span>Kepala Desa : </span>Badan Pengusaha</a>
                                </td>
                            </tr>
                        </tbody>
                        <!--end::Tbody-->
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-wrap gap-5 mb-7">
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="subtitle" class="form-control mb-2" value="" placeholder="Subjudul"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    @error('subtitle')
