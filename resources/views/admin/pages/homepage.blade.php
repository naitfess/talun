                ...
                <div class="d-flex flex-column gap-7 gap-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <!--end::Image input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Foto dan nama Kepala Desa dapat diedit melalui halaman 
                                <a href="{{ route('admin.perangkat-desa.index') }}">ini</a>.
                            </div>
                            <!--end::Description-->
                        </div>
                        <!--begin::Card body-->
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-7 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="product_name" class="form-control mb-2" placeholder="Product name" value="{{ $village_head->name }}" disabled/>
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Foto dan nama Kepala Desa dapat diedit melalui halaman 
                                    <a href="{{ route('admin.perangkat-desa.index') }}">ini</a>.
                            ...
                            <div>
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea name="kd_description" class="form-control h-150px mb-2"></textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-7 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="tt_subtitle" class="form-control mb-2" placeholder="Subjudul" value="" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                @error('tt_subtitle')
                                <div class="text-danger fs-7">{{ $message }}</div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <div class="d-flex flex-wrap gap-5">
                                    ...
                                    <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="tt_title_1" class="form-control mb-2" placeholder="Judul 1" value="" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        @error('tt_title_1')
                                        <div class="text-danger fs-7">{{ $message }}</div>
                                        ...
                                        <textarea name="tt_description_1" class="form-control h-150px mb-2" placeholder="Deskripsi 1"></textarea>
                                        ...
                                        <input type="text" name="tt_url_1" class="form-control mb-2" placeholder="Url 1" value="" />
                                        @error('tt_url_1')
                                    ...
                                    <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="tt_title_2" class="form-control mb-2" placeholder="Judul 2" value="" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        @error('tt_title_2')
                                        <div class="text-danger fs-7">{{ $message }}</div>
                                        ...
                                        <textarea name="tt_description_2" class="form-control h-150px mb-2" placeholder="Deskripsi 2"></textarea>
                                        ...
                                        <input type="text" name="tt_url_2" class="form-control mb-2" placeholder="Url 2" value="" />
                                        @error('tt_url_2')
                                        <div class="text-muted fs-7 pb-2 border-bottom-sm">{{ $message }}</div>
                                        @else
                                        <div class="text-muted fs-7 pb-2 border-bottom-sm">Set the product VAT about.</div>
                                    ...
                                    <div class="fv-row w-100 flex-md-root">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="tt_title_3" class="form-control mb-2" placeholder="Judul 3" value="" />
                                        <!--end::Input-->
                                        <!--begin::Description-->
                                        @error('tt_title_3')
                                        <div class="text-danger fs-7">{{ $message }}</div>
                                        ...
                                        <textarea name="tt_description_3" class="form-control h-150px mb-2" placeholder="Deskripsi 3"></textarea>
                                        ...
                                        <input type="text" name="tt_url_3" class="form-control mb-2" placeholder="Url 3" value="" />
                                        @error('tt_url_3')
                                        <div class="text-muted fs-7 pb-2 border-bottom-sm">{{ $message }}</div>
                                        @else
                                        <div class="text-muted fs-7 pb-2 border-bottom-sm">Set the product VAT about.</div>
                        ...
                        <div class="card-body pt-0">
                            <div class="d-flex flex-wrap gap-5 mb-7">
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="sdt_subtitle" class="form-control mb-2" value="" placeholder="Subjudul"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    @error('sdt_subtitle')
                                    <div class="text-danger fs-7">{{ $message }}</div>
                                ...
                                <div class="fv-row w-100 flex-md-root">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="number" name="sdt_population" class="form-control mb-2" value="" placeholder="Jumlah Penduduk"/>
                                    <!--end::Input-->
                                    <!--begin::Description-->
                            ...
                            <div>
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <textarea name="sdt_description" class="form-control h-150px mb-2" placeholder="Deskripsi"></textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                                ...
                                <div class="dropzone" id="dropzone1">
                                    ...
                                    <div class="dz-message needsclick">
                                        ...
                                        <div class="ms-4">
                                            ...
                                            <span class="fs-7 fw-semibold text-gray-500">Upload your profile video!</span>
                                        </div>
                                        <!--end::Info-->
                                    </div>
                                </div>
                            ...
                            <div class="fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="vp_subtitle" class="form-control mb-2" placeholder="Subjudul" value="" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                @error('vp_subtitle')
                                <div class="text-danger fs-7">{{ $message }}</div>
